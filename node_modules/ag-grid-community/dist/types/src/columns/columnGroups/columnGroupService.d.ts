...
export declare class ColumnGroupService extends BeanStub implements NamedBean {
    ...
    balanceColumnTree(unbalancedTree: (AgColumn | AgProvidedColumnGroup)[], currentDept: number, columnDept: number, columnKeyCreator: ColumnKeyCreator): (AgColumn | AgProvidedColumnGroup)[];
